...
<?php tpl_display(get_template_path('form_errors')) ?>
  ...
  <fieldset>
    ...
    <div>
      ...
      <?php echo text_field('contact[display_name]', array_var($contact_data, 'display_name'), array('class' => 'form-control', 'id' => 'contactFormDisplayName')) ?>
    </div>

    <div>
      <?php echo label_tag(lang('first name'), 'contactFormFirstName', false) ?>
      <?php echo text_field('contact[first_name]', array_var($contact_data, 'first_name'), array('class' => 'form-control', 'id' => 'contactFormFirstName')) ?>
    </div>

    <div>
      <?php echo label_tag(lang('middle name'), 'contactFormMiddleName', false) ?>
      <?php echo text_field('contact[middle_name]', array_var($contact_data, 'middle_name'), array('class' => 'form-control', 'id' => 'contactFormMiddleName')) ?>
    </div>

    <div>
      <?php echo label_tag(lang('last name'), 'contactFormLastName', false) ?>
      <?php echo text_field('contact[last_name]', array_var($contact_data, 'last_name'), array('class' => 'form-control', 'id' => 'contactFormLastName')) ?>
    </div>
  </fieldset>
...
<?php if (!$contact->isAdministrator()) { ?>
  <fieldset>
    ...
    <div>
      <?php echo radio_field('contact[company][what]', array_var(array_var($contact_data, 'company'), 'what') != 'new', array('value' => 'existing', 'id'=>'contactFormExistingCompany', 'class' => '')); ?>
      <?php echo label_tag(lang('existing company'), 'contactFormExistingCompany', false, array('class' => '')) ?>
    </div>
    <div id="contactFormExistingCompanyControls">
      <?php echo select_company('contact[company_id]', array_var($contact_data, 'company_id'), array('id' => 'contactFormCompany', 'class' => 'form-control')) ?>
    </div>
  
    <div>
      <?php echo radio_field('contact[company][what]', array_var(array_var($contact_data, 'company'), 'what') == 'new', array('value' => 'new', 'id'=>'contactFormNewCompany', 'class' => '')); ?>
      <?php echo label_tag(lang('new company'), 'contactFormNewCompany', false, array('class'=>''))?>
    </div>
    <div id="contactFormNewCompanyControls">
      <?php echo label_tag(lang('company name'), 'contactFormNewCompanyName', true) ?>
      <?php echo text_field('contact[company][name]', null, array('class' => 'form-control', 'id' => 'contactFormNewCompanyName')) ?>
      <?php echo label_tag(lang('timezone'), 'contactFormNewCompanyTimezone', true)?>
      <?php echo select_timezone_widget('contact[company][timezone]', owner_company()->getTimezone(), array('id' => 'contactFormNewCompanyTimezone', 'class' => 'form-control long combobox')) ?>
    </div>
  </fieldset>
...
<?php } // if ?>
  ...
  <div>
    ...
    <?php echo text_field('contact[title]', array_var($contact_data, 'title'), array('class' => 'form-control', 'id' => 'contactFormTitle')) ?>
  </div>

  <div>
    <?php echo label_tag(lang('email address'), 'contactFormEmail', false) ?>
    <?php echo text_field('contact[email]', array_var($contact_data, 'email'), array('class' => 'form-control long', 'id' => 'contactFormEmail')) ?>
  </div>
...
<?php } // if ?>
  ...
  <fieldset>
    ...
    <div>
      ...
      <?php echo text_field('contact[office_number]', array_var($contact_data, 'office_number'), array('class' => 'form-control', 'id' => 'contactFormOfficeNumber')) ?>
    </div>
    
    <div>
      <?php echo label_tag(lang('fax number'), 'contactFormFaxNumber') ?>
      <?php echo text_field('contact[fax_number]', array_var($contact_data, 'fax_number'), array('class' => 'form-control', 'id' => 'contactFormFaxNumber')) ?>
    </div>
    
    <div>
      <?php echo label_tag(lang('mobile phone number'), 'contactFormMobileNumber') ?>
      <?php echo text_field('contact[mobile_number]', array_var($contact_data, 'mobile_number'), array('class' => 'form-control', 'id' => 'contactFormMobileNumber')) ?>
    </div>
    
    <div>
      <?php echo label_tag(lang('home phone number'), 'contactFormHomeNumber') ?>
      <?php echo text_field('contact[home_number]', array_var($contact_data, 'home_number'), array('class' => 'form-control', 'id' => 'contactFormHomeNumber')) ?>
    </div>
  ...
  <fieldset>
    ...
    <div>
      ...
      <?php echo text_field('contact[language_preferences]', array_var($contact_data, 'language_preferences'), array('class' => 'form-control', 'id' => 'contactFormLanguagePreferences')) ?>
    </div>
   
    <div>
      <?php echo label_tag(lang('food preferences'), 'contactFormFoodPreferences') ?>
      <?php echo text_field('contact[food_preferences]', array_var($contact_data, 'food_preferences'), array('class' => 'form-control', 'id' => 'contactFormFoodPreferences')) ?>
    </div>
    
    <div>
      <?php echo label_tag(lang('license plate'), 'contactFormLicensePlate') ?>
      <?php echo text_field('contact[license_plate]', array_var($contact_data, 'license_plate'), array('class' => 'form-control', 'id' => 'contactFormLicensePlate')) ?>
    </div>
    
    <div>
      <?php echo label_tag(lang('department details'), 'contactFormDepartmentDetails') ?>
      <?php echo text_field('contact[department_details]', array_var($contact_data, 'department_details'), array('class' => 'form-control', 'id' => 'contactFormDepartmentDetails')) ?>
    </div>
    
    <div>
      <?php echo label_tag(lang('location details'), 'contactFormLocationDetails') ?>
      <?php echo text_field('contact[location_details]', array_var($contact_data, 'location_details'), array('class' => 'form-control', 'id' => 'contactFormLocationDetails')) ?>
    </div>
