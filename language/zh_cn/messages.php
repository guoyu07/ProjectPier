...
return array (
    ...
    'no status updates associated with object' => '提交的数据并无该对象的状态更新',
    'no messages in project' => '这个项目上没有消息',
    'no subscribers' => '没有用户订阅这个消息',
    'no contacts in company' => '该公司没有联系人',
    ...
    'about to move' => '你将移动',
    'no image functions' => '无图像函数 (要安装GD库)',
    'no ldap functions' => '无LDAP函数(要安装ldap扩展)',
    ...
    'success edit logo' => 'Logo被更新了',
    'success delete logo' => 'Logo已被删除',
    ...
    'success move message' => '消息 \'%s\' 已从项目： \'%s\' to project \'%s\' 中移除',
    ...
    'success add contact' => '联系人 %s 添加成功',
    'success edit contact' => '联系人t %s 更新成功',
    'success delete contact' => '联系人 %s 删除成功',
    ...
    'error edit logo' => '更新logo %s 失败',
    'error delete logo' => '删除logo %s 失败',
    'error delete client' => '所选客户公司删除失败',
    'error delete user' => '所选用户删除失败',
    'error delete contact' => '所选联系人删除失败',
    ...
    'error move message' => '移动所选消息 %s 失败',
    'error move task list' => '移动所选任务清单失败',
    ...
    'confirm delete logo' => '确定要删除该logo?',
    ...
    'confirm delete contact' => '确定要删除该联系人?',
    ...
    'log edit projects' => '项目 \'%s\' 被更新',
    'log open projects' => '项目 \'%s\' 被开启',
    'log close projects' => '项目 \'%s\' 被关闭',
    'log delete projects' => '项目 \'%s\' 被删除',
    
    'log add users' => '用户 \'%s\' 被添加',
    'log edit users' => '用户 \'%s\' 被更新',
    'log delete users' => '用户 \'%s\' 被删除',
    
    'log add companies' => '公司 \'%s\' 被添加',
    'log edit companies' => '公司 \'%s\' 被更新',
    'log delete companies' => '公司 \'%s\' 被删除',
    
    'log add contacts' => '联系人 \'%s\' 被添加',
    'log edit contacts' => '联系人 \'%s\' 被更新',
    'log delete contacts' => '联系人 \'%s\' 被删除',
    
    'log add i18nlocales' => 'Locale \'%s\' 被添加',
    'log edit i18nlocales' => 'Locale \'%s\' 被更新',
    'log delete i18nlocales' => 'Locale \'%s\' 被删除',
    
    'log add i18localevalues' => 'Locale 值 \'%s\' 被添加',
    'log edit i18nlocalevalues' => 'Locale 值 \'%s\' 被更新',
    'log delete i18nlocalevalues' => 'Locale 值 \'%s\' 被删除'
); // array
